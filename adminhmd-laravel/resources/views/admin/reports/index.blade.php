                            ...
                            <tbody>
                                @foreach ($top_products as $i => $p)
                                    <tr>
                                        ...
                                        <td class="text-center"><span class="badge bg-primary">{{ $p->total_sold }}</span>
                                        </td>
                                ...
                                @foreach ($top_categories as $i => $c)
                                    <tr>
                                        ...
                                        <td class="text-center"><span
                                                class="badge bg-info text-dark">{{ $c->total_sold }}</span></td>
                                        <td class="text-end text-success fw-bold">
                                            ${{ number_format($c->total_revenue, 2) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
