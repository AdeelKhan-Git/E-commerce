                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <p style="color:#555;">Thank you for your order! We've received it and it's now being
                                processed.</p>
                            ...
                            <table width="100%" style="border-collapse:collapse;margin:20px 0;">
                                ...
                                <tr>
                                    <td colspan="2"
                                        style="padding:15px 0 0;text-align:right;font-weight:bold;font-size:16px;">Order
                                        Total:</td>
                                    <td
                                        style="padding:15px 0 0;text-align:right;font-weight:bold;font-size:16px;color:#00a8b3;">
                                        ${{ number_format($order->total_amount, 2) }}</td>
                                </tr>
                            </table>

                            <table width="100%"
                                style="background:#f9f9f9;border-radius:4px;padding:15px;margin:20px 0;border-collapse:collapse;">
                                <tr>
                                    <td style="padding:5px;"><strong>Order Number:</strong></td>
                                    <td style="padding:5px;color:#ff006e;font-weight:bold;">{{ $order->order_number }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px;"><span
                                            style="background:#fff3cd;color:#856404;padding:2px 8px;border-radius:4px;">{{ ucfirst($order->order_status) }}</span>
                                    </td>
                                </tr>
                            </table>
