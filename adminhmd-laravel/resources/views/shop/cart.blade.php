    ...
    <div class="container" style="padding:40px 0;">
        ...
        @if ($cart_items->isEmpty())
            <div class="checkout-card text-center py-5">
                ...
                <i class="bi bi-cart-x" style="font-size:75px;color:var(--pearl-aqua);display:block;margin-bottom:20px;">
                </i>
            ...
            <div class="row g-4">
                        ...
                        <div class="cart-item">
                            <div class="cart-row d-flex flex-column flex-md-row gap-3 align-items-center">
                                ...
                                <form method="POST" action="{{ route('cart.remove', $item) }}">
                                    @csrf @method('DELETE')
                                    <button type="button" class="remove-cart-btn" data-bs-toggle="modal"
                                        data-bs-target="#removeCartModal" data-url="{{ route('cart.remove', $item) }}"
                ...
                <div class="col-lg-4">
                    <div class="cart-total-box shadow-sm">
                        ...
                        <a href="{{ route('checkout.index') }}" class="btn-primary-custom w-100 text-center"
                        ...
                        <a href="{{ route('shop') }}" class="link-secondary d-block text-center mt-4">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"
                ...
                <div class="modal-body text-center">
                    <i class="bi bi-cart-x" style="font-size:55px;color:var(--neon-pink);"></i>
