                    ...
                    <div id="billing-fields">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" id="full_name" class="form-control-dark"
                                    value="{{ $user->username }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="phone" class="form-control-dark"
                                    value="{{ $user->phone_number }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label-dark">Street Address *</label>
                                <input type="text" id="address" class="form-control-dark" value="{{ $user->address }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="postcode" class="form-control-dark"
                                    value="{{ $user->postcode }}">
                            </div>
                            <div class="col-12">
            ...
            <div class="col-lg-5">
                    ...
                    <table style="width:100%;">
                        <thead>
                            <tr style="border-bottom:1px solid var(--border);">
                                ...
                                <td style="padding:8px 0;color:var(--text-muted);font-size:13px;text-align:right;">Total
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($cart_items as $item)
                                <tr style="border-bottom:1px solid var(--border);">
                                    ...
                                    <td style="padding:10px 0;text-align:right;color:var(--stormy-teal);">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td
                                    style="padding:12px 0;text-align:right;color:var(--stormy-teal);font-weight:900;font-size:20px;">
                ...
                <div class="checkout-card">
                    ...
                    <div class="pay-section active" id="section-cod">
                        <div
                            style="background:var(--alice-blue);border:1px solid var(--border);border-radius:8px;padding:15px;margin-bottom:15px;">
                        ...
                        <button type="button" class="btn-primary-custom w-100" style="font-size:16px;padding:14px;"
                            id="cod-btn" onclick="submitCOD()">
                    ...
                    <div class="pay-section" id="section-stripe">
                        <div id="card-element"
                            style="background:var(--bg-secondary);border:1px solid var(--border);border-radius:8px;padding:15px;margin-bottom:10px;">
                        </div>
                        <div id="card-errors" style="color:#dc3545;font-size:13px;min-height:20px;margin-bottom:10px;">
                        </div>
                        <div style="color:var(--text-muted);font-size:12px;margin-bottom:15px;">
                            <i class="bi bi-lock me-1"></i>Secured by Stripe
                        </div>
                        <button type="button" class="btn-primary-custom w-100" style="font-size:16px;padding:14px;"
                            id="stripe-btn" onclick="submitStripe()">
                            <span id="stripe-btn-text">Pay ${{ number_format($grand_total, 2) }}</span>
                            <span id="stripe-spinner" style="display:none;"><i class="bi bi-arrow-repeat"></i>
                                Processing...</span>
                        </button>
                    </div>
                </div>
